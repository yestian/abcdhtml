...
class DesignLogo extends Component{
    render(){
        return(
            <div className="bem-DesignerLogo">
                <div className="bem-DesignerLogo_Button">
                    ...
                    <div className="bem-DesignerLogo_Icon bem-DesignerLogo_Icon-menu">
                        <svg width="30" height="24" viewBox="0 0 30 24" className="bem-Svg" style={{display: 'block', transform: 'translate(0px, 0px)'}}><rect width="30" height="4" rx="1" ry="1" fill="currentColor"></rect><rect y="10" width="30" height="4" rx="1" ry="1" fill="currentColor"></rect><rect y="20" width="30" height="4" rx="1" ry="1" fill="currentColor"></rect></svg>
                    </div>
                </div>
                <span></span>
            </div>
