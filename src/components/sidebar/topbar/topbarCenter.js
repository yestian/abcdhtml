    ...
    render(){
        return(
            <div className="bem-TopBar_Body_Group">
                <div className="bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton bem-TopBar_Body_MediaQueryButton-active" data-automation-id="media-pc" onClick={(e)=>this.props.onClick(e)}
                ...
                <div className="bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton" data-automation-id="media-tablet" onClick={(e)=>this.props.onClick(e)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
                ...
                <div className="bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton" data-automation-id="media-landscape" onClick={(e)=>this.props.onClick(e)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
                ...
                <div className="bem-TopBar_Body_Button bem-TopBar_Body_MediaQueryButton" data-automation-id="media-portrait" onClick={(e)=>this.props.onClick(e)}
                onMouseEnter={(e)=>this.props.onMouseEnter(e)}
                onMouseLeave={(e)=>this.props.onMouseLeave(e)}>
