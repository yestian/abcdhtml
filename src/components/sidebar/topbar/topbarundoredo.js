    ...
    render(){
        return(
            <div className="bem-TopBar_Body_UndoRedo">
                <div data-automation-id="topbar-undo" className="bem-TopBar_Body_Button bem-TopBar_Body_UndoRedo_Undo ">
                ...
                <div data-automation-id="topbar-redo" className="bem-TopBar_Body_Button bem-TopBar_Body_UndoRedo_Redo ">
